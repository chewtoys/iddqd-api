...
export const validatePassword = (password: string, min: number = 6, max: number = 64): Promise<void> => new Promise((resolve, reject) => {
...
export const validateComparePassword = (password: string, confirmPassword: string): Promise<void> => new Promise((resolve, reject) => {
...
export const validateEmail = (email: string): Promise<void> => new Promise((resolve, reject) => {
...
export const validateUserData = (data: UserData): Promise<void> => new Promise((resolve, reject) => {
...
export const validateLogin = (data: UserData): Promise<void> => new Promise((resolve, reject) => {
    if (!data.password || !data.email) reject('Email and/or password is missing');
    else validatePassword(data.password, 6)
        .then(() => validateEmail(data.email))
        .then(() => resolve())
